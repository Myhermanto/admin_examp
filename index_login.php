...
<head>
    ...
    <link rel="stylesheet" href="admin/css/sign-in.css">
    ...
    <link rel="mask-icon" href="admin/img/favicons/safari-pinned-tab.svg" color="#712cf9">
    <link rel="icon" href="admin/img/favicons/favicon.ico">
